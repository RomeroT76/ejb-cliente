...
a persistence unit "clientePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "cliente/pom.xml":
...
artifact ("cliente.war") is already built. You can build
